...
| 指令 | 描述 | 权限要求 |
| :--- | :--- | :--- |
| `#ai配置登陆` | 获取 Web 管理后台的一次性登录链接 | 管理员 |
| `#ai状态` | 查看当前 AI 服务的运行指标与负载 | 管理员 |
| `#加入本群ai` | 开启当前群组的 AI 智能回复功能 | 管理员 |
| `#关闭本群ai` | 暂停当前群组的 AI 功能 | 管理员 |
| `#配置ai模型 <名称>` | 动态切换底层 LLM 模型 (如 gpt-4, claude-3) | 管理员 |
